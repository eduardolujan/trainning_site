...
env.project_name = 'trainning_site'
env.repository = 'git@github.com:lincolnloop/trainning_site.git'
...
def dev():
    ...
    """
    server = 'trainning_site.dev.lincolnloop.com'
    env.roledefs = {
        'web': [server],
        'db': [server],
    }
